  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-24 right-8 z-40 w-16 h-16 bg-gradient-to-r from-primary to-green-600 text-white rounded-full shadow-2xl hover:shadow-primary/25 transition-all duration-300 hover:scale-110 animate-glow ${isOpen ? 'hidden' : 'flex'} items-center justify-center`}
      >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-8 right-8 z-50 w-80 h-96 bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col animate-scale-in">
          {/* Header */}
